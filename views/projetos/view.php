                ...
                <div>
                    ...
                    <div class="metrics">
                        <div class="metric-box">
                            <div class="metric-value"><?php echo count($projeto['membros']); ?></div>
                            <div class="metric-label">Membros</div>
                        </div>
                        <div class="metric-box">
                            <div class="metric-value"><?php echo count($projeto['atividades']); ?></div>
                            <div class="metric-label">Atividades</div>
                        </div>
                        <div class="metric-box">
                            <div class="metric-value"><?php echo number_format($projeto['total_horas'], 1); ?>h</div>
